...
precio_m = float(input('\nIngrese el valor del Martillo: '))
...
print(f'\nSubtotal Martillo: ${round(subtotal_m, 2)} CLP | Subtotal Clavos: ${round(subtotal_c, 2)} CLP | Subtotal Serrucho: ${round(subtotal_s, 2)} CLP | Subtotal Tornillos: ${round(subtotal_t, 2)} CLP')
