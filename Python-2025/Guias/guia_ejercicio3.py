...
if sum_listajuan < 500000:
    print(f'Juan no cuenta con ningún bono, su sueldo a pagar es de: ${sueldo_base} ')
elif sum_listajuan >= 500000 and sum_listajuan < 1000000:
    sueldo_j5 = sueldo_base + (sueldo_base * 5/100)
    print(f'Juan cuenta con un bono del 5%, su sueldo a pagar es de ${sueldo_j5}')
elif sum_listajuan >= 1000000 and sum_listajuan < 1500000:
    sueldo_j10 = sueldo_base + (sueldo_base * 10/100)
    print(f'Juan cuenta con un bono del 10%, su sueldo a pagar es de ${sueldo_j10}')
elif sum_listajuan >= 1500000:
    sueldo_j20 = sueldo_base + (sueldo_base * 20/100)
    print(f'Juan cuenta con un bono del 20%, su sueldo a pagar es de ${sueldo_j20}')
...
if sum_listasergio< 500000:
    ...
    print(f'Juan cuenta con un bono del 5%, su sueldo a pagar es de ${sueldo_s5}')
elif sum_listasergio >= 1000000 and sum_listasergio < 1500000:
    sueldo_s10 = sueldo_base + (sueldo_base * 10/100)
    print(f'Juan cuenta con un bono del 10%, su sueldo a pagar es de ${sueldo_s10}')
elif sum_listasergio >= 1500000:
    sueldo_s20 = sueldo_base + (sueldo_base * 20/100)
    print(f'Juan cuenta con un bono del 20%, su sueldo a pagar es de ${sueldo_s20}')
...
if sum_listaroberto< 500000:
    ...
    print(f'Juan cuenta con un bono del 5%, su sueldo a pagar es de ${sueldo_r5}')
elif sum_listaroberto >= 1000000 and sum_listaroberto < 1500000:
    sueldo_r10 = sueldo_base + (sueldo_base * 10/100)
    print(f'Juan cuenta con un bono del 10%, su sueldo a pagar es de ${sueldo_r10}')
elif sum_listaroberto >= 1500000:
    sueldo_r20 = sueldo_base + (sueldo_base * 20/100)
    print(f'Juan cuenta con un bono del 20%, su sueldo a pagar es de ${sueldo_r20}')